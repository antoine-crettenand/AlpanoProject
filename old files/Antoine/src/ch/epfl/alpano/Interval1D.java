...
public final class Interval1D {
	...
	public int sizeOfIntersectionWith(Interval1D that) {
		...
		try { //If lowerBound > upperBound then the interval is the empty set
	...
	public Interval1D boundingUnion(Interval1D that) {
		...
		Interval1D union = new Interval1D(lowerBound, upperBound);
	...
	@Override public boolean equals(Object thatO) {
		...
		if (includedFrom() != that.includedFrom())
			return false;
		return includedTo() == that.includedTo();
	}
