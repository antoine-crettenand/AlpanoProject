...
public interface Azimuth {
    ...
    /**
	 * Compute if azimuth is canonical or not
	 *
	 ...
	 * @throws IllegalArgumentException if {@param azimuth} is not canonical
	 * @see #isCanonical(double)
	 */
	 ...
	 * @throws IllegalArgumentException if {@param angle} is not canonical
	 * @see #isCanonical(double)
	 */
