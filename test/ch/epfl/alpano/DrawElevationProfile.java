...
final class DrawElevationProfile {
	...
	final static double LONGITUDE = toRadians(6.15432); //6.15432
	final static double LATITUDE = toRadians(46.20562); //46.20562
	final static int WIDTH = 800, HEIGHT = 100;//100
