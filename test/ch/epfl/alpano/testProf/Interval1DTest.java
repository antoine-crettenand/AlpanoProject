...
import static ch.epfl.alpano.test.ObjectTest.hashCodeIsCompatibleWithEquals;
...
public class Interval1DTest {
	...
	@Test(expected = IllegalArgumentException.class) public void constructorFailsForInvalidBounds() {
		new Interval1D(1, 0);
	}

	@Test public void constructorWorksForSingletonInterval() {
		new Interval1D(10, 10);
	}

	@Test public void containsIsTrueOnlyForTheIntervalsElements() {
	...
	@Test public void containsWorksAtTheLimit() {
		Random rng = newRandom();
	...
	@Test public void sizeWorksOnKnownIntervals() {
	...
	@Test public void sizeOfIntersectionWorksOnNonIntersectingIntervals() {
	...
	@Test public void sizeOfIntersectionWorksOnIntersectingIntervals() {
	...
	@Test public void boundingUnionWorksOnKnownIntervals() {
	...
	@Test public void isUnionableWithWorksOnKnownIntervals() {
	...
	@Test(expected = IllegalArgumentException.class) public void unionFailsOnNonUnionableIntervals() {
		i_0_2().union(i_6_9());
	}

	@Test public void unionWorksWhenOneIntervalContainsTheOther() {
		assertEquals(i_0_9(), i_0_9().union(i_3_5()));
		assertEquals(i_0_9(), i_3_5().union(i_0_9()));
	}

	@Test public void unionWorksWithASingleInterval() {
		assertEquals(i_3_5(), i_3_5().union(i_3_5()).union(i_3_5()));
	}

	@Test public void unionWorksWhenOneIntervalIsContiguousWithTheOther() {
		Interval1D i = i_0_2().union(i_6_9().union(i_3_5()));
		assertEquals(i_0_9(), i);
	}

	@Test public void equalsIsStructural() {
		Random rng = newRandom();
		for (int i = 0; i < RANDOM_ITERATIONS; ++i) {
	...
	@Test public void hashCodeAndEqualsAreCompatible() {
		Random rng = newRandom();
		for (int i = 0; i < RANDOM_ITERATIONS; ++i) {
			int a = rng.nextInt(), b = rng.nextInt();
