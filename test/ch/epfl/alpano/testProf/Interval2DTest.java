...
public class Interval2DTest {
	...
	@Test(expected = NullPointerException.class) public void constructorFailsOnInvalidInterval() {
		new Interval2D(null, null);
	}

	@Test public void containsWorksOnKnownIntervals() {
	...
	@Test public void boudingUnionWorksOnKnownIntervals() {
	...
	@Test public void isUnionableWorksOnKnownUnionableIntervals() {
	...
	@Test public void isUnionableWorksOnKnownNonUnionableIntervals() {
	...
	@Test public void isUnionableWithIsReflexive() {
	...
	@Test public void isUnionableWithIsSymmetric() {
		Random rng = newRandom();
		for (int i = 0; i < RANDOM_ITERATIONS; ++i) {
	...
	@Test public void unionWorksOnASingleInterval() {
		assertEquals(i_0_10_0_10(),
				i_0_10_0_10().union(i_0_10_0_10().union(i_0_10_0_10())));
	}

	@Test public void unionWorksOnKnownIntervals() {
	...
	@Test public void unionIsCommutative() {
		Random rng = newRandom();
		for (int i = 0; i < RANDOM_ITERATIONS; ++i) {
			Interval2D i1 = nextInterval(rng, 5, 10);
			Interval2D i2 = nextInterval(rng, 5, 10);
