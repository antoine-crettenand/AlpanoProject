...
public final class DrawDEM {
	@SuppressWarnings("resource") public static void main(String[] args)
		...
		DiscreteElevationModel dDEM2 = new WavyDEM(
				new Interval2D(new Interval1D(50, 100),
		...
		ImageIO.write(elI, "png", new File("test/testOutput/elevation.png"));
		ImageIO.write(slI, "png", new File("test/testOutput/slope.png"));
	}
